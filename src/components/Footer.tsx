...
const legal = [
  ...
  { label: "Complaints Channel", href: "/contact" },
  { label: "Quality Policy", href: "/contact" },
];
...
const socials = [
  ...
  { label: "YouTube",  href: "https://www.youtube.com/channel/UCoW1Ip3gM6YjBtluhSCJpBA", icon: <path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58zM9.75 15.02V8.98L15.5 12l-5.75 3.02z" fill="currentColor" /> },
  { label: "LinkedIn", href: "https://www.linkedin.com/company/pluginfy-technologies", icon: <><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z" fill="currentColor" /><circle cx="4" cy="4" r="2" fill="currentColor" /></> },
];
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 pt-12 sm:pt-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.2fr] gap-8 sm:gap-10 lg:gap-12 mb-10 sm:mb-12">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {nav1.map((link) => (
                <li key={link.label}>
                  <a href={link.href} className="text-base transition-colors hover:text-white" style={{ color: "rgba(255,255,255)" }}>{link.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <span className="text-base" style={{ color: "rgba(255,255,255)" }}>307 Madina Heights, Lahore, Pakistan</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 order-1 sm:order-2">
            {legal.map((item) => (
              <a key={item.label} href={item.href} className="text-xs transition-colors hover:text-white" style={{ color: "rgba(255,255,255)" }}>
                {item.label}
              </a>
            ))}
          </div>
