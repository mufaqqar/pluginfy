...
const services = [
  {
    ...
    tools: [
      { name: "Python", icon: "/images/123.png", color: "#3776AB" },
      { name: "OpenAI", icon: "/images/123.png", color: "#74AA9C" },
      { name: "TensorFlow", icon: "/images/123.png", color: "#FF6F00" },
      { name: "PyTorch", icon: "/images/123.png", color: "#EE4C2C" },
      { name: "LangChain", icon: "/images/123.png", color: "#FFFFFF" },
    ],
...

  {
    ...
    projects: ["SaaS Platforms", "Enterprise ERPs", "E-commerce Stores"],
    tools: [
      { name: "React", icon: "/images/123.png", color: "#61DAFB" },
      { name: "Python", icon: "/images/123.png", color: "#3776AB" },
      { name: "PostgreSQL", icon: "/images/123.png", color: "#336791" },
    ],
...

  {
    ...
    projects: ["SaaS Platforms", "Enterprise ERPs", "E-commerce Stores"],
    tools: [
      { name: "Flutter", icon: "/images/123.png", color: "#54C5F8" },
      { name: "React Native", icon: "/images/123.png", color: "#61DAFB" },
      { name: "Swift", icon: "/images/123.png", color: "#FA7343" },
      { name: "React", icon: "/images/123.png", color: "#61DAFB" },
    ],
...

  {
    ...
    tools: [
      { name: "Selenium", icon: "/images/123.png", color: "#43B02A" },
      { name: "Cypress", icon: "/images/123.png", color: "#69D3A7" },
      { name: "Jest", icon: "/images/123.png", color: "#C21325" },
      { name: "k6", icon: "/images/123.png", color: "#7D64FF" },
    ],
...

  {
    ...
    tools: [
      { name: "AWS", icon: "/images/123.png", color: "#FF9900" },
      { name: "Terraform", icon: "/images/123.png", color: "#7B42BC" },
      { name: "Docker", icon: "/images/123.png", color: "#2496ED" },
      { name: "Kubernetes", icon: "/images/123.png", color: "#326CE5" },
    ],
...

  {
    ...
    tools: [
      { name: "Solidity", icon: "/images/123.png", color: "#FFFFFF" },
      { name: "Ethereum", icon: "/images/123.png", color: "#627EEA" },
      { name: "IPFS", icon: "/images/123.png", color: "#65C2CB" },
      { name: "Hardhat", icon: "/images/123.png", color: "#FFF100" },
      { name: "Web3.js", icon: "/images/123.png", color: "#F16822" },
    ],
