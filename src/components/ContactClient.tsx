...
export default function ContactClient() {
  ...
  return (
    <div style={{ background: "#07091A" }}>
      ...
      {/* ── Info section ── */}
      <section className="relative pt-20 pb-14 sm:pt-30 sm:pb-0 overflow-hidden" style={{ background: "#07091A" }}>
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6">
          ...
          <FadeIn y={20} duration={0.5}>
            <div className="flex items-center gap-2 mb-4 text-xs" style={{ fontFamily: "var(--font-heading)" }}>
          ...
          <FadeIn y={30} delay={0.1} duration={0.6}>
            <h1
              ...
              style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(2.8rem,8vw,4rem)", color: "white", letterSpacing: "-0.03em" }}
            >
              Let's Talk.
            </h1>
          </FadeIn>
          <FadeIn y={30} delay={0.15} duration={0.6}>
            <p className="mb-8 max-w-xl" style={{ color: "rgba(255,255,255,0.5)", fontSize: "1rem", lineHeight: 1.4 }}>
          ...
          >
            {/* Opening hours */}
            <StaggerItem>
              <div className="py-4 h-full sm:pr-10" style={{ borderRight: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            {/* Mail */}
            <StaggerItem>
              <div className="py-4 h-full sm:px-10" style={{ borderRight: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            {/* Socials */}
            <StaggerItem>
              <div className="py-4 h-full sm:pl-10">
                ...
                <div className="flex items-center gap-4 mt-1">
                  {[
                    { label: "Facebook", href: "https://www.facebook.com/pluginfy", icon: <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" fill="currentColor" /> },
                    { label: "Twitter", href: "https://twitter.com/pluginfy", icon: <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" fill="currentColor" /> },
                    { label: "YouTube", href: "https://www.youtube.com/channel/UCoW1Ip3gM6YjBtluhSCJpBA", icon: <><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-2C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33 2.78 2.78 0 0 0 1.95 2C5.12 19.55 12 19.55 12 19.55s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-2 29 29 0 0 0 .46-5.33 29 29 0 0 0-.46-5.34z" fill="currentColor" /><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" fill="#07091A" /></> },
                    { label: "LinkedIn", href: "https://www.linkedin.com/company/pluginfy-technologies", icon: <><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" fill="currentColor" /><rect x="2" y="9" width="4" height="12" fill="currentColor" /><circle cx="4" cy="4" r="2" fill="currentColor" /></> },
                  ].map((s) => (
                    <a
                      key={s.label}
                      href={s.href}
                ...
                <div className="mt-4 flex items-start gap-2">
                  ...
                  <p className="text-sm" style={{ color: "rgba(255,255,255,0.4)", lineHeight: 1.5 }}>307 Madina Heights, Lahore, Pakistan</p>
                </div>
              </div>
            </StaggerItem>
          </StaggerContainer>
      ...
      {/* ── Form section ── */}
      <section className="py-10 sm:py-10" style={{ background: "#0A0D1E" }}>
            ...
            <FadeIn x={-30} duration={0.6}>
              <div>
                <h2
                  ...
                  style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(1.4rem, 3.5vw, 2.2rem)", color: "white", lineHeight: 1.3, letterSpacing: "-0.02em" }}
                >
                  LET'S WORK
                  <br />
                  TOGETHER
                </h2>
                <p className="mb-8 max-w-[530px]" style={{ color: "rgba(255,255,255)", lineHeight: 1.4, fontSize: "16px" }}>
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3">
                      ...
                      {item.href ? (
                        <a href={item.href} className="text-base transition-colors text-white">{item.text}</a>
                      ) : (
      ...
      <section className="py-10" style={{ background: "#07091A" }}>
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6">        
          <div>
            <FadeIn x={-30} duration={0.6}>
              <h2
                className="font-heading font-extrabold mb-4 leading-tight text-center"
                style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(1.4rem, 3.5vw, 2.2rem)", color: "white", letterSpacing: "-0.02em" }}
              >
                Our services
              </h2>
            </FadeIn>
